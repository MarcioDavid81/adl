  ...
  return (
    <div className="min-h-screen bg-[#1E3B39] text-white flex flex-col items-center">
      <div className="container mx-auto p-4">
          <h1 className="text-3xl font-bold mb-4">Política Privacidade</h1>
          <p>
            A sua privacidade é importante para nós. É política do ADL - Comércio de
            Cereais LTDA respeitar a sua privacidade em relação a qualquer
            informação sua que possamos coletar no site ADL - Comércio de Cereais
            LTDA, e outros sites que possuímos e operamos. Solicitamos informações
            ...
            oficiais sobre privacidade do Google AdSense. Utilizamos anúncios para
            compensar os custos de funcionamento deste site e fornecer financiamento
            para futuros desenvolvimentos. Os cookies de publicidade comportamental
            usados ​​por este site foram projetados para garantir que você forneça
            os anúncios mais relevantes sempre que possível, rastreando anonimamente
            seus interesses e apresentando coisas semelhantes que possam ser do seu
            ...
            ADL - Comércio de Cereais LTDA oferece no site e com caráter
            enunciativo, mas não limitativo: A) Não se envolver em atividades que
            sejam ilegais ou contrárias à boa fé a à ordem pública; B) Não difundir
            propaganda ou conteúdo de natureza racista, xenofóbica, jogos de sorte
            ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo
            ou contra os direitos humanos; C) Não causar danos aos sistemas físicos
            (hardwares) e lógicos (softwares) do ADL - Comércio de Cereais LTDA, de
            ...
            a partir de 23 April 2025 12:33
          </p>
      </div>
      <Link href="/">
        <Button className="mt-4 bg-[#E6B325] text-gray-800 hover:bg-[#E6B325]/90">Voltar</Button>
      </Link>
    </div>
  );
}
